...
| Herufi ndogo za aina za msingi (n8/n16/n32/n64/a*/d32/d64/b*/w* — sanjari na herufi kubwa, aina MOJA HASA, si aina mpya) — kwenye mkusanyaji uliojijenga (stage1/stage2) KAMILI; kwenye mbegu YENYEWE kwa aina 6 TU (n8/n16/n32/n64/w0/d64 — mzizi wa bootstrap umegandishwa upya 2026-09-24, angalia CONTRIBUTING.md "Sheria ya Mzizi wa Uaminifu") — mbegu bado HAIJUI familia A/B wala D32 kwa hali yoyote ya herufi. Majaribio 179 na maktaba 5 za jumla (mpangilio/nasibu/orodha/ramani/wakati.swa) zimehamishiwa herufi ndogo 2026-09-23/24. Faili zinazojengwa moja kwa moja na mbegu.bin (kumbukumbu.swa, mfuatano.swa, faili.swa, hesabu.swa, gharama/msuluhishi.swa, zana/umbizaji.swa, na msingi/mkusanyaji/*.swa) zilikuwa HAZIWEZI kuhamishwa kabla ya mbegu kugandishwa upya (#257) — sasa Awamu B inaendelea: kumbukumbu, mfuatano, faili, hesabu, msuluhishi, na umbizaji.swa zimehamishwa (Awamu B ya kwanza); msomaji, mteremko, mkaguzi, msambazaji, uzalishaji.swa na stage1.swa bado herufi kubwa, kazi inayoendelea. Zana/umbizaji.swa ilihitaji ziada: jedwali lake la kutambua majina ya aina lilikuwa herufi kubwa TU, halikutambua "n32*" kama kielekezi cha aina (nafasi ya ziada kimya) — limerekebishwa. Pengo lililojulikana: ukaguzi wa "jina la aina halitumiki kama usemi" (`tenga N32` unakataliwa) haufanyi kazi kwa tahajia ya herufi ndogo (`tenga n32` hukubaliwa kimya) — kwa makusudi, kuepuka mgongano na vitambulisho vya ndani vya mkusanyaji (a1..a6, b1..b3) — angalia issue #255; vivyo hivyo `ukubwa(x)` kwenye mbegu (jina la muundo lililo HASA n8/n16/n32/n64/d64 linatafsiriwa kimya kama aina ya msingi — hati/mipaka.md #10) | PR #225, #256, #257; jaribio_tenga_jina_la_aina.swa na jaribio_herufi_ndogo_kubwa_muunganiko.swa (zimebaki herufi maalum kimakusudi); jaribio_mbegu_herufi_ndogo (haina alama ya stage1) |
