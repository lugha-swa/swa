...
| Herufi ndogo za aina za msingi (n8/n16/n32/n64/a*/d32/d64/b*/w*) NDIYO PEKEE zinazokubalika sasa — herufi KUBWA (N32, D64, W0 n.k.) ZIMEONDOLEWA KABISA (Awamu D, IMEKAMILIKA): chanzo chochote kinachotumia herufi kubwa ya aina hakikusanywi tena, kwenye mbegu WALA kwenye mkusanyaji uliojijenga (stage1/stage2). mbegu (mzizi wa bootstrap) bado inatambua familia 6 TU (n8/n16/n32/n64/w0/d64 — freeze ya PILI ya mzizi wa uaminifu, 2026-09-26, iliyoondoa matawi ya herufi kubwa yaliyokuwepo, angalia CONTRIBUTING.md "Sheria ya Mzizi wa Uaminifu"); bado HAIJUI familia A/B wala D32 kwa hali yoyote ya herufi (hii haikubadilika — familia hizo hazikuhitaji kuongezwa, kwa kuwa hakuna faili moja kwenye hazina inayozitumia kama msimbo halisi, maoni/nukuu za jedwali TU). Awamu B (#261-#271, faili 13/13 zinazojengwa moja kwa moja na mbegu.bin) na Awamu C (#272-278, faili zote zilizobaki za mradi) zilihamisha kila kitu kwenda herufi ndogo KWANZA (bila kuondoa uungwaji mkono wa herufi kubwa bado); Awamu D (#279) ndiyo iliyofuta uungwaji mkono wa herufi kubwa KABISA kwenye mbegu.s (matawi 6) na msambazaji.swa (familia 5: N/A/D/B/W). jaribio_herufi_ndogo_kubwa_muunganiko.swa (lililokuwa likithibitisha N32/n32 ni aina moja) LIMEFUTWA na Awamu D — lengo lake halliwezekani tena kisintaksia. jaribio_tenga_jina_la_aina.swa limebaki (bado linatumia `tenga N32` kimakusudi) kwa sababu linajaribu kazi TOFAUTI (ni_aina_msingi, ukaguzi wa "jina la aina kama usemi" — angalia pengo hapa chini), isiyotegemea uwepo wa N32 kama aina halisi. Pengo lililojulikana (bado lipo, halijabadilishwa na Awamu D): ukaguzi wa "jina la aina halitumiki kama usemi" (`tenga N32` unakataliwa) haufanyi kazi kwa tahajia ya herufi ndogo (`tenga n32` hukubaliwa kimya) — kwa makusudi, kuepuka mgongano na vitambulisho vya ndani vya mkusanyaji (a1..a6, b1..b3) — angalia issue #255; vivyo hivyo `ukubwa(x)` kwenye mbegu (jina la muundo lililo HASA n8/n16/n32/n64/d64 linatafsiriwa kimya kama aina ya msingi — hati/mipaka.md #10). Pengo JIPYA lililopatikana wakati wa Awamu D (halijarekebishwa, si zuiliwa na uondoaji wa herufi kubwa): jina lisilotambuliwa KABISA likitumika kama aina ya kurudi ya kazi ya ngazi ya juu (mfano `Kitu main(){...}`) linakubaliwa kimya na changanua_aina_tokeni kama muundo wa mtumiaji asiyejulikana badala ya kukataliwa — imethibitishwa kuwa tabia hii ilikuwepo KABLA ya Awamu D pia. | PR #225, #256-#278 (Awamu B/C), #279 (Awamu D — uondoaji); jaribio_tenga_jina_la_aina.swa (kimebaki kimakusudi); jaribio_mbegu_herufi_ndogo (haina alama ya stage1) |
