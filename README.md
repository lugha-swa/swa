...
- **Majaribio**: 199 yanapita (146 maktaba + 52 ujumuishaji + 1 nyaraka). K6 bootstrap inafanya kazi.
...
```sh
cargo build --release
cargo test          # Majaribio 199: 146 ya maktaba + 52 ya ujumuishaji + 1 wa nyaraka
```
